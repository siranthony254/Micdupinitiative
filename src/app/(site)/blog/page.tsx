          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {featuredPosts.map((post) => (
                <article key={post._id} className="border border-gray-800 rounded-lg overflow-hidden hover:border-amber-500 transition-shadow" style={{backgroundColor: '#1A3A5C'}}>
                  {post.mainImage && (
        ...
        <section>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="border border-gray-800 rounded-lg p-6 animate-pulse" style={{backgroundColor: '#1A3A5C'}}>
